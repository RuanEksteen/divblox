if (typeof component_classes['navigation_user_top_nav'] === "undefined") {
	class navigation_user_top_nav extends DivbloxDomBaseComponent {
	...
	component_classes['navigation_user_top_nav'] = navigation_user_top_nav;
}