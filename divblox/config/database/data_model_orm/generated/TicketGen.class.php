 ...
 * @property string $TicketUniqueId the value for strTicketUniqueId 
...
class TicketGen extends dxBaseClass implements IteratorAggregate {
    ...
    const TicketDescriptionMaxLength = 150;
    ...
    */
    public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
        ...
        $strAliasName = !empty($strColumnAliasArray[$strAlias]) ? $strColumnAliasArray[$strAlias] : $strAlias;
        $objToReturn->strTicketDescription = $objDbRow->GetColumn($strAliasName, 'VarChar');
    ...
    */
    ...
    public function __get($strName) {
        switch ($strName) {
            ...
            case 'TicketUniqueId':
                /**
                 * Gets the value for strTicketUniqueId 
                 * @return string
                 */
    ...
    public function __set($strName, $mixValue) {
        switch ($strName) {
            ...
            case 'TicketUniqueId':
                /**
                 * Sets the value for strTicketUniqueId 
                 * @param string $mixValue
                 * @return string
                 */
                try {
	...
	class dxQueryNodeTicket extends dxQueryNode {
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'TicketDescription':
					return new dxQueryNode('TicketDescription', 'TicketDescription', 'VarChar', $this);
				case 'TicketDueDate':
